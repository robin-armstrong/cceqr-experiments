This repository contains code which replicates the numerical experiments in R. Armstrong and A. Damle, *Collect, Commit, Expand: Efficient CPQR-Based Column Selection for Extremely Wide Matrices*, 2025, https://export.arxiv.org/abs/2501.18035.
...
## Running Experiments
Experiments are located within the `src/experiments` directory, and are intended to be run from the top level. To run a particular experiment, enter
```
